...
// The accordion directive simply sets up the directive modules
  ...
  return {
    ...
    compile: function(element, attr, transclude) {
      return function link(scope, element, attr, accordionGroupCtrl) {
        // Pass the heading to the accordion-group modules
...
// You must provide the property on the accordion-group modules that will hold the transcluded element
...
dialogModule.provider("$dialog", function(){
  ...
  var defaults = {
    ...
    /* other options: template, templateUrl, modules */
	};
  ...
  function ($http, $document, $compile, $rootScope, $controller, $templateCache, $q, $transition, $injector) {
    ...
    // containing at lest template or templateUrl and modules:
    //
    //     var d = new Dialog({templateUrl: 'foo.html', modules: 'BarController'});
    //
    // Dialogs can also be created using templateUrl and modules as distinct arguments:
    //
    ...
    // The `open(templateUrl, modules)` method opens the dialog.
    // Use the `templateUrl` and `modules` arguments if specifying them at dialog creation time is not desired.
    ...
    // Loads all `options.resolve` members to be used as locals for the modules associated with the dialog.
    ...
    return {
      ...
      // creates a new `Dialog` tied to the default message box template and modules.
      //
...
.directive('modal', ['$parse', '$dialog', function($parse, $dialog) {
  return {
    ...
    link: function(scope, elm, attrs) {
      ...
      // Add the current scope as the resolve in order to make the directive scope as a dialog modules scope
...
.controller('TabsController', ['$scope', '$rootScope', '$element', function($scope, $rootScope, $element) {
